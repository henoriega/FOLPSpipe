    ...
    def _initialize_factors(self, cosmo=None, k=None):
        ...
        if self.kernels == 'eds':
            ...
            if cosmo is not None and 'z' in self.kwargs:
                ...
                self.inputfkT = f_over_f0_EH(zev=self.kwargs['z'], k=k, OmM0=self.kwargs['Omega_m'], h=self.kwargs['h'], fnu=self.kwargs['fnu'], Neff=self.kwargs.get('Neff', 3.044), Nnu=self.kwargs.get('Nnu', 3))
