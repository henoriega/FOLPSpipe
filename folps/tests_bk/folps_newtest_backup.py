...
class BispectrumCalculator:
    ...
    def Bisp_Sugiyama(self, f, f0, bpars, pk_input, z_pk,
                      k1k2pairs, qpar, qperp, precision=[4, 5, 5]):
        ...
        for ii in range(size):
            ...
            B000[ii], B202[ii] = self.Sugiyama_B000_B202(
                k1, k2, f, f0, sigma2v_, bpars, qpar, qperp, tablesGL, pk_input)

        return B000, B202

    def Sugiyama_B000_B202(self, k1, k2, f, f0, sigma2v, bpars, qpar, qperp, tablesGL, pk_in):
        ...
        bisp = self.bispectrum(k1, k2, x_mesh, mu_mesh, phi_mesh,
                               f, f0, sigma2v, bpars, qpar, qperp, pk_in)
